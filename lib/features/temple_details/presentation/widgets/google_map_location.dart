  ...
  void initState() {
    ...
    if (widget.temple != null) {
      ...
      _selectedDistanceIndex.value =
          distanceList.indexOf(widget.currentLocationData?['distance'] ?? 5.0);
      // zoom level
      double zoomLevel = widget.currentLocationData?['distance'] ?? 5.0;
              ...
              child: Stack(
                children: [
                  GoogleMap(
                    ...
                    myLocationEnabled:
                        widget.currentLocationData?['current_location'] != null
                            ? true
                            : false,
                  ...
                  //     top: 10,
                  //     left: 10,
                  //     child: _buildSelectDistanceWidget(context)),
                ],
              ),
            );
            // }
